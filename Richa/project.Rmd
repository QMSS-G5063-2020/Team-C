...
# Load packages.
packages <- c("ggplot2", "tidyverse", "wbstats", "rgdal", "leaflet", "dplyr", "lubridate", "hrbrthemes", "viridis","countrycode")
...
# Migration Case Study: Analysis of sdaksdjakls Top 3 Migration Outflows {.tabset .tabset-fade}
